...
class Run(BaseRun):
    ...
    def normalize_data(
        ...
        qlib_data_1d_dir cannot be None, normalize 5min needs to use 1d data;
            ...
            or:
                download 1d data, reference: https://github.com/microsoft/qlib/tree/main/scripts/data_collector/all_source#1d-from-yahoo
        ...
        if qlib_data_1d_dir is None or not Path(qlib_data_1d_dir).expanduser().exists():
            raise ValueError(
                "If normalize 5min, the qlib_data_1d_dir parameter must be set: --qlib_data_1d_dir <user qlib 1d data >, Reference: https://github.com/microsoft/qlib/tree/main/scripts/data_collector/all_source#automatic-update-of-daily-frequency-datafrom-yahoo-finance"
            )
